...
# Generated: Mon Jul  1 21:42:18 2019
##################################################
...
class combine_signals(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_3_0 = blocks.file_source(gr.sizeof_char*1, 'injector2_signal.bin', False)
        self.blocks_file_source_3 = blocks.file_source(gr.sizeof_char*1, 'injector1_signal.bin', False)
        ...
        self.connect((self.blocks_file_source_3, 0), (self.blocks_stream_mux_0, 3))
        self.connect((self.blocks_file_source_3_0, 0), (self.blocks_stream_mux_0, 4))
